...
Klon Open Source programu Microcal Origin, narzędzia do analizy i
wizualizacji danych.
...
Przykłady pokazujące możliwości programu SciGraphica.
...
#Summary(pl):	Kolejny wirtualny terminal, tym razem całkiem niewielki
...
#Kolejny wirtualny terminal, tym razem całkiem niewielki
